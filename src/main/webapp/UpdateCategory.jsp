...
<body>
	...
	<div class="container">
		<form:form action="manage_category_update" method="post"
			modelAttribute="category">
			<div class="form-group">
				<label for="Selected Category ID">ID:</label>
				<form:input path="id" type="text" class="form-control" id="categ"
					placeholder="Enter ID" />
			</div>
			<div class="form-group">
				<label for="Selected Category Name">Name:</label>
				<form:input path="name" type="text" class="form-control" id="pwd"
			...
			<table style="width: 100%; border-spacing: 25px; border: 2px">
				...
				<c:forEach items="${categoryList}" var="category">
					...
					<tr style="height: 30px">
						...
						<td><a href="manage_categoriy_remove">Delete</a></td>
					</tr>
				</c:forEach>
			</table>
